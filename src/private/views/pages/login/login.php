...
<html lang="en">
    ...
    <head>
        ...
        <script src="<?php echo $settings['siteurl']; ?>/node_modules/bootstrap/dist/js/bootstrap.min.js"></script></head>
    ...
    <body class="text-center">
        ...
        <main class="form-signin">
          <form method="POST">
            ...
            <div class="mb-3 mt-4">
                <label>
                 Don't have an account <a href="<?php echo $settings['siteurl']; ?>/pages/register">sign up</a>
                </label>
              </div>
